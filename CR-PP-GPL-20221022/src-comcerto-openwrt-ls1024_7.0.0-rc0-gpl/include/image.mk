...
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2kmfcnevm),y)
define Image/mkfs/yaffs2_mfcnevm
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_mfcnevm/yaffs2_configcert $(BIN_DIR)/root_configcert.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_mfcnevm/yaffs2_webrootdb $(BIN_DIR)/root_webrootdb.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_mfcnevm/yaffs2_license $(BIN_DIR)/root_license.yaffs2 -v 2>&1 1>/dev/null
	chmod +r $(BIN_DIR)/*.yaffs2
endef
endif

ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2krv16x-26x),y)
define Image/mkfs/yaffs2_rv16x_26x
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv16x_26x/yaffs2_configcert $(BIN_DIR)/root_configcert.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv16x_26x/yaffs2_webrootdb $(BIN_DIR)/root_webrootdb.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv16x_26x/yaffs2_license $(BIN_DIR)/root_license.yaffs2 -v 2>&1 1>/dev/null
	chmod +r $(BIN_DIR)/*.yaffs2
endef
endif
...
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2kmfcnevm),y)
define Image/mfcnevmpackage
        ( cd ${BIN_DIR} ; \
          cp ${TOPDIR}/vendor/mfcnevm_fw_pack.sh . ; \
          ./mfcnevm_fw_pack.sh ${TOPDIR}/vendor \
        )
endef
endif

ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2krv16x-26x),y)
define Image/rv16x_26xpackage
	( cd ${BIN_DIR} ; \
          cp ${TOPDIR}/vendor/rv16x_26x_fw_pack.sh . ; \
          ./rv16x_26x_fw_pack.sh ${TOPDIR}/vendor \
	)
endef
endif
...
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2kmfcnevm),y)
	$(call Image/mfcnevmpackage)
	$(call Image/mkfs/yaffs2)
endif
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2krv16x-26x),y)
	# $(call Image/rv16x_26xpackage)
	$(call Image/mkfs/yaffs2_rv16x_26x)
endif
endef
